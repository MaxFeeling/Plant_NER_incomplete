...
def parse_arguments(parser):
    ...
    parser.add_argument('--device', type=str, default="cuda", choices=['cpu', 'cuda:0', 'cuda:1', 'cuda:2'],
                        help="GPU/CPU devices")
    parser.add_argument('--seed', type=int, default=42, help="random seed")
    parser.add_argument('--digit2zero', action="store_true", default=True,
                        help="convert the number to 0, make it true is better")
    parser.add_argument('--dataset', type=str, default="Plant")
    parser.add_argument('--embedding_file', type=str, default="data/gigaword_chn.all.a2b.bi.ite50.vec",
    ...
    parser.add_argument('--model_folder', type=str, default="plant_model", help="The name to save the model files")
...
def train_model(config: Config, train_insts: List[List[Instance]], dev_insts: List[Instance], test_insts: List[Instance]):
    ...
    for iter in range(num_outer_iterations):
        ...
        for fold_id, folded_train_insts in enumerate(train_insts):
            ...
            model_name = model_folder + f"/plant_crf_{fold_id}.m"
